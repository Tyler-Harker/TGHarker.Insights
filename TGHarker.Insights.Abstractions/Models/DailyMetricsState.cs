...
[GenerateSerializer]
[Searchable(typeof(IDailyMetricsGrain))]
public sealed class DailyMetricsState
{
    ...
    [Id(12)] public Dictionary<string, int> PageViewsByPath { get; set; } = new();
    [Id(13)] public Dictionary<string, int> SessionsBySource { get; set; } = new();
}
